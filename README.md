...
| Popular Stations  | Casual Riders overwhelmingly start their rides **near tourist attractions** (i.e., Millennium Park, Navy Pier, etc.) whereas the stations with the highest activity for Annual Members are spread more evenly throughout the city (likely because Members use their bikes to commute)     |
