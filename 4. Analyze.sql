...
This query allows us to see the total number of trips taken from each station (with the most popular stations at the top of the list), and also
...
This query essentially shows the same information as the query above, but is prepared in a way that will be easier to visualize in Tableau.
